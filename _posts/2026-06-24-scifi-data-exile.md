...
Oblivion 提供的不是匿名化，不是VPN，不是假身份。是**数据层面的死亡**。他们会黑进所有存有你的数字痕迹的数据库——社保、银行、信用记录、运营商、社交平台、政府档案——把所有能关联到你的条目标记为"已故"或直接物理删除。
...
2037. Third month unemployed. Ninth job interview. The HR auto-reply:
